...
# 
#   data_x <- data[data$unique_id %in% train_x,]
#   data_y <- data[data$unique_id %in% train_y,]
# 
#   data_x <- data_x %>%
...
# x_files <- list.files("output/processed_data_whole1", pattern="dataX", full.names = TRUE)
# y_files <- list.files("output/processed_data_whole1", pattern="dataY", full.names = TRUE)
# 
...
# 
# saveRDS(train_y, "output/whole_train_y4.RDS")
# saveRDS(train_y_lab, "output/whole_train_y_lab4.RDS")
# 
# #######
# 
# print("loading data")
...
# print("saving backup files")
# 
# saveRDS(train_x, "output/whole_train_x4.RDS")
# saveRDS(train_x_lab, "output/whole_train_x_lab4.RDS")
...
train_x <- readRDS("output/whole_train_x.RDS")
train_x_lab <- readRDS("output/whole_train_x_lab.RDS")
train_y <- readRDS("output/whole_train_y.RDS")
train_y_lab <- readRDS("output/whole_train_y_lab.RDS")

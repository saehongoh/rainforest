...
max_iter = 25
files <- list.files("output/processed_data_set2", pattern="data", full.names = TRUE)
...
for(i in 1:length(files)){
  ...
  repeat {
    ...
    file_name = paste0("output/trained_models_set3/species_", res_table$species_id, "_iter_", j, ".h5")
  ...
  saveRDS(export, paste0("output/trained_models_set3/species_", res_table$species_id,"_res.RDS"))

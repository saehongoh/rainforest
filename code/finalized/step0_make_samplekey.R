...
saveRDS(rbind(cohort1_test, cohort1_train), "output/finalized/cohort1_key.rds")
saveRDS(rbind(cohort2_test, cohort2_train), "output/finalized/cohort2_key.rds")
saveRDS(rbind(cohort3_test, cohort3_train), "output/finalized/cohort3_key.rds")
